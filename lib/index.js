  ...
  app.get('/', (req, res) => {
    ...
    let page = dom('html',
      dom('head',
        ...
        dom('meta property="og:title" content="Join Huntsvegas on Slack!"'),
        dom('meta property="og:url" content="https://huntsvegas.us"'),
        dom('meta name="og:image" content="https://huntsvegas.us/assets/hv-logo.png"'),
